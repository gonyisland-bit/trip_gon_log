          ...
          <div className="text-center relative">
            ...
            {isEditMode ? (
              <input
                ...
                onClick={(e) => e.stopPropagation()}
                className="bg-[#EAE8E3] dark:bg-white/10 px-1 pl-2 pr-8 py-0.5 outline-none text-[9px] md:text-xs font-bold text-black dark:text-white border border-black/10 dark:border-white/10 rounded-sm text-left w-32 mt-1"
              />
            ) : (
